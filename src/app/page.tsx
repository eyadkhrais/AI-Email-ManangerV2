      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          <div className="flex items-center">
            <h1 className="text-xl font-bold text-black">AI Gmail Manager</h1>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <div className="text-center">
            ...
            <div className="mt-10">
              <Link
                href="/signup"
                className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800"
              >
                Get Started
              </Link>
            </div>
          ...
          {/* Features */}
          <div className="mt-24 grid grid-cols-1 gap-12 md:grid-cols-3 text-white">
            <div className="text-center">
              ...
              <h3 className="mt-6 text-xl font-medium text-white">Gmail Integration</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="mt-6 text-xl font-medium text-white">AI-Driven Drafts</h3>
              <p className="mt-2 text-base text-gray-200">
            ...
            <div className="text-center">
              ...
              <h3 className="mt-6 text-xl font-medium text-white">Dashboard & Analytics</h3>
              <p className="mt-2 text-base text-gray-200">
